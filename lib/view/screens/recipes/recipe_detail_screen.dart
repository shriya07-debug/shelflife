...
class RecipeDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // context.watch rebuilds this widget whenever any of these VMs notify —
          ...
          SliverAppBar(
            ...
            actions: [
              IconButton(
                ...
                onPressed: () =>
                    context.read<RecipeVM>().toggleFavorite(recipe.id),
              ),
            ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...recipe.ingredients.map((ing) {
                      ...
                      final inList = shoppingVM.all.any(
                              (s) => s.name.toLowerCase() == ing.toLowerCase());
                      return Padding(
                        padding: const EdgeInsets.symmetric(vertical: 6),
                        child: Row(
                          children: [
                            Icon(
                              have ? Icons.check_circle : Icons.cancel_outlined,
                              color: have ? AppColors.safe : AppColors.danger,
                              size: 20,
                            ),
                            ...
                            if (!have)
                              TextButton.icon(
                                ...
                                icon: Icon(
                                  inList ? Icons.check : Icons.add_shopping_cart,
                                  size: 16,
                                  color: inList
                                      ? AppColors.safe
